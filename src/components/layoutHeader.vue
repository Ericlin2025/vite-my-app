...
.hd{
    ...
    .loginStatus{
        ...
        button{
            background-color: rgba(0, 184, 129, 0.774);
            color: white;
            width: 80px;
            height: 30px;
            border: none;
